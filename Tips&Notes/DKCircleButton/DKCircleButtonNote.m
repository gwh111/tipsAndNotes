...
@implementation DKCircleButtonNote
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _highLightView.backgroundColor = [UIColor colorWithRed:126/255.f green:39/255.f blue:39/255.f alpha:0.5];
        
        _borderColor = [UIColor colorWithRed:126/255.f green:39/255.f blue:39/255.f alpha:1];
        _animateTap = YES;

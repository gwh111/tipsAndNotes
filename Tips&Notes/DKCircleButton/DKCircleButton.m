...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _highLightView.backgroundColor = [UIColor colorWithRed:0.29 green:0.59 blue:0.81 alpha:0.5];
        
        _borderColor = [UIColor colorWithRed:0.29 green:0.59 blue:0.81 alpha:1];
        _animateTap = YES;
